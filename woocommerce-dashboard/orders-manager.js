/**
 * Orders & Delivery Tracking Manager - USD Currency
 */
...
class OrdersManager {
    ...
    renderOrdersTable() {
        ...
        let orders = window.wcStore.getOrders();
        ...
        document.getElementById('count-all-orders').textContent = countAll;
        document.getElementById('count-pending-orders').textContent = countPending;
        document.getElementById('count-processing-orders').textContent = countProcessing;
        document.getElementById('count-delivered-orders').textContent = countDelivered;
        document.getElementById('count-undelivered-orders').textContent = countUndelivered;
