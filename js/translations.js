...
const TRANSLATIONS = {
  en: {
    ...
    subtotal: "Subtotal",
    shipping: "Shipping",
    shipping_val: "Calculated at next step",
    grand_total: "Estimated Total",
    checkout_btn: "Proceed to Checkout",
    
    // Checkout Modal
    checkout_title: "Complete Your Order",
    shipping_details: "1. Shipping Details",
    ...
    success_desc: "Your order has been placed successfully. We will contact you soon to coordinate delivery.",
  ...
  ar: {
    ...
    shipping: "الشحن",
    shipping_val: "يُحسب في الخطوة التالية",
    grand_total: "الإجمالي التقريبي",
    checkout_btn: "الذهاب للدفع",
    
    // Checkout Modal
    checkout_title: "إتمام عملية الشراء",
    shipping_details: "١. تفاصيل الشحن والتوصيل",
    ...
    success_desc: "شكراً لتسوقك معنا. تم إرسال تفاصيل طلبك وسنقوم بالتواصل معك لتنسيق شحن المنتجات في أقرب وقت.",
