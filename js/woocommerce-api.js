    ...
    if (typeof PRODUCTS !== 'undefined' && Array.isArray(PRODUCTS) && PRODUCTS.length > 0) {
        return PRODUCTS.map(p => {
            ...
            return {
                ...
                image: `http://127.0.0.1:8085/global-kitchen/${p.image}`,
...
const INITIAL_DEMO_ORDERS = [
    ...
    },
    {
        ...
        status: "processing", // processing / قيد المعالجة
    ...
    },
    {
        ...
        status: "delivered", // delivered / تم التسليم
    ...
    },
    {
        ...
        status: "undelivered", // undelivered / لم يتم التسليم
...
class WooCommerceStoreManager {
    ...
    initStorage() {
        // ALWAYS force refresh catalog & orders to pure USD ($) dataset
    ...
    addProduct(productData) {
        ...
        const newProduct = {
            ...
            image: productData.image || 'http://127.0.0.1:8085/global-kitchen/assets/products/img_p1_1.jpeg',
    ...
    getSettings() {
        try {
            return JSON.parse(localStorage.getItem(STORAGE_KEYS.SETTINGS)) || {
                store_url: 'http://127.0.0.1:8085/global-kitchen',
                consumer_key: 'ck_globalkitchen_live_key',
                consumer_secret: 'cs_globalkitchen_live_secret',
                is_connected: true
            };
        } catch(e) {
            return { store_url: 'http://127.0.0.1:8085/global-kitchen', consumer_key: '', consumer_secret: '', is_connected: true };
        }
    }
